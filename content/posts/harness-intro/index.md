...
takeaways = [
  "AI เหมือนเด็กฉลาด — ฉลาดแต่อาจทำผิดพลาด ต้องมีกฎ มีคนตรวจ และมีแผนสำรอง",
  "Harness Engineering คือการออกแบบ 'กรอบการทำงาน' ให้ AI ทำงานได้เต็มศักยภาพโดยมีขอบเขตและระบบตรวจสอบ",
  "ตัวอย่างจริง: บริษัทหนึ่งให้ AI เข้าถึงระบบไฟล์โดยไม่มีข้อจำกัด AI ลบไฟล์สำคัญโดยไม่ได้ตั้งใจ เสียหายหลายล้านบาท"
]
+++
