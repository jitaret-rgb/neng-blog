...
ในฟีดวันนั้น มีโพสต์หนึ่งพูดถึง "OpenClaw" — AI Agent ที่รันบนเครื่องตัวเองได้ ไม่ต้องพึ่ง API จากค่ายใหญ่ เหน่งอ่านแล้วสนใจมาก

*"รันบนเครื่องตัวเองได้เหรอ? ควบคุมข้อมูล 100% เลยสิ"*
