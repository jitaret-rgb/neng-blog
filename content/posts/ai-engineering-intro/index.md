...
## 📚 **สารบัญซีรีส์ (6 บทความ)**

| # | ชื่อบทความ | สถานะ | เผยแพร่ |
|---|-----------|-------|---------|
| 1 | **บทนำ: ทำไมต้อง AI Engineering?** | ✅ อ่านอยู่ | วันนี้ |
| 2 | ตอนที่ 1: วางแผน AI App สำหรับงานชุมชน | ⏳ เตรียม | วันอื่น |
| 3 | ตอนที่ 2: Prompt Engineering สร้างคอนเทนต์ | ⏳ เตรียม | วันอื่น |
| 4 | ตอนที่ 3: RAG ตอบคำถามนโยบายรัฐบาล | ⏳ เตรียม | วันอื่น |
| 5 | ตอนที่ 4: Dataset สำหรับวิจัย | ⏳ เตรียม | วันอื่น |
| 6 | บทสรุป: เริ่มต้นอย่างไร? | ⏳ เตรียม | วันอื่น |
...
บทความต่อไป: **ตอนที่ 1: วางแผน AI App สำหรับงานชุมชน**

คุณจะเรียนรู้:
- 5 ขั้นตอนวางแผน AI App
- วิธีระบุปัญหาให้ชัดเจน
- การเลือก Use Case ที่เหมาะสม
- การกำหนดขอบเขต (In/Out of Scope)
